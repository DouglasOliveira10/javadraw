...
import { canRemove, canvasReducer, emptyCanvas, type CanvasState } from './canvasState'
...
describe('canvasReducer', () => {
  ...
  it('toggles members and drops call edges left without an anchor', () => {
  ...
  it('keeps positions from moves and arrange', () => {
    ...
    const arranged = canvasReducer(moved, { type: 'arrange', positions: { [BOLETO]: { x: 0, y: 0 } } })
