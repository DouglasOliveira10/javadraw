...
export const en = {
  ...
  'edge.resetRoute': 'Reset the route',
  'edge.resetRouteHint': 'Forget the pinned ends and the bend points, and route the line automatically again',
...
export const ptBR: Record<MessageKey, string> = {
  ...
  'edge.resetRoute': 'Refazer o traçado',
  'edge.resetRouteHint': 'Esquece as pontas fixadas e os pontos de quebra, voltando ao traçado automático',
